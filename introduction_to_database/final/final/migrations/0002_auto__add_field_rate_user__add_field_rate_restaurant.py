...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rate.user'
        db.add_column(u'final_rate', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Rate.restaurant'
        db.add_column(u'final_rate', 'restaurant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['final.Restaurant']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rate.user'
        db.delete_column(u'final_rate', 'user_id')

        # Deleting field 'Rate.restaurant'
        db.delete_column(u'final_rate', 'restaurant_id')
